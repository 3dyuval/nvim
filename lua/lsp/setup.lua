...
vim.lsp.config("vue_ls", {filetypes = {"vue"}, root_markers = ts_root_markers, init_options = {vue = {hybridMode = true}}, settings = {vue = {complete = {casing = {tags = "kebab", props = "kebab"}}}}, on_init = _8_})
