...
function M.smart_resolve_union()
  ...
  vim.cmd("!git show :1:" .. vim.fn.shellescape(file) .. " > " .. temp_base .. " 2>/dev/null || echo '' > " .. temp_base)
  vim.cmd("!git show :2:" .. vim.fn.shellescape(file) .. " > " .. temp_ours .. " 2>/dev/null || echo '' > " .. temp_ours) 
  vim.cmd("!git show :3:" .. vim.fn.shellescape(file) .. " > " .. temp_theirs .. " 2>/dev/null || echo '' > " .. temp_theirs)
