...
vim.api.nvim_create_autocmd("FileType", {pattern = {"snacks_win", "snacks_picker", "snacks_explorer"}, callback = _39_})
local function _40_()
  vim.opt_local.swapfile = false
...
vim.api.nvim_create_autocmd("BufReadPre", {pattern = {(vim.fn.expand("~") .. "/mnt/*"), (vim.fn.expand("~") .. "/.sshfs/*")}, callback = _40_})
local function _41_()
  local function _42_()
...
vim.api.nvim_create_autocmd({"BufWinEnter", "WinEnter", "TabEnter"}, {callback = _41_})
local function _44_()
...
vim.api.nvim_create_autocmd({"BufEnter", "BufWinEnter"}, {pattern = {"*.ts", "*.tsx", "*.js", "*.jsx"}, callback = _44_})
local function _48_()
...
vim.api.nvim_create_autocmd("VimLeavePre", {callback = _50_})
local function _52_()
...
vim.api.nvim_create_autocmd("BufWinEnter", {callback = _52_})
local function _55_()
  for _, win in ipairs(vim.api.nvim_list_wins()) do
...
vim.api.nvim_create_autocmd("FocusGained", {callback = _55_})
