...
local bindings = {["@function.outer"] = {["move-next"] = {"]f"}, ["move-prev"] = {"[f"}, ["move-end-next"] = {"]M"}, ["move-end-prev"] = {"[M"}, select = "tf", ["swap-next"] = "]F", ["swap-prev"] = "[F"}, ["@function.inner"] = {select = "rf"}, ["@class.outer"] = {["move-next"] = {"]C"}, ["move-prev"] = {"[C"}}, ["@parameter.inner"] = {["move-next"] = {"]p"}, ["move-prev"] = {"[p"}, ["swap-next"] = "]P", ["swap-prev"] = "[A"}, ["@loop.*"] = {["move-next"] = {"]l"}, ["move-prev"] = {"[l"}}, ["@scope"] = {["move-next"] = {"]s"}, ["move-prev"] = {"[s"}, select = "rs"}, ["@fold"] = {["move-next"] = {"]u"}, ["move-prev"] = {"[u"}}, ["@tag.inner"] = {select = "rt"}, ["@tag.outer"] = {select = "tt"}, ["@block.inner"] = {select = "rb"}, ["@block.outer"] = {select = "tb"}, ["@jsx_self_closing_element"] = {select = "te"}}
