...
local function _1_()
  ...
  local cdiffview = require("integration.diffview-cdiffview")
  local function _2_(_opts)
    return cdiffview.open()
  end
  return vim.api.nvim_create_user_command("DiffviewGraphCDiffView", _2_, {desc = "Open gitgraph as CDiffView"})
end
local function _3_()
