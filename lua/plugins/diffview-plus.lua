...
return {"dlyongemallo/diffview-plus.nvim", dependencies = {"nvim-tree/nvim-web-devicons", "isakbm/gitgraph.nvim"}, keys = {{"<leader>gf", ":DiffviewGraphCDiffView<CR>", "desc", "Open gitgraph as diff view"}}, init = _1_, opts = _3_, dev = false}
