...
return {"dlyongemallo/diffview-plus.nvim", dependencies = {"nvim-tree/nvim-web-devicons", "isakbm/gitgraph.nvim"}, cmd = {"DiffviewOpen", "DiffviewToggle", "DiffviewFileHistory", "DiffviewGraph", "DiffviewDiffFiles", "DiffviewMergeFiles", "DiffviewDiffDirs"}, opts = _1_, dev = false}
