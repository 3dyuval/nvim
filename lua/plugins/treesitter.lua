...
local function _1_()
  return require("arborist").setup({update_cadence = "weekly", ensure_installed = {"lua", "vim", "vimdoc", "query", "markdown", "markdown_inline", "go", "rust", "ruby", "javascript", "typescript", "tsx", "python", "bash", "json", "yaml", "toml", "elixir", "heex", "vue", "css", "scss", "html", "kcl"}, overrides = {kcl = {url = "https://github.com/KittyCAD/tree-sitter-kcl"}}})
end
local function _2_()
