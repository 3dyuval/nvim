...
return {{"aaronik/treewalker.nvim", opts = {highlight = true, highlight_duration = 250, highlight_group = "CursorLine", jumplist = true}}, {"arborist-ts/arborist.nvim", branch = "dev", config = _1_, lazy = false}, {"nvim-treesitter/nvim-treesitter", branch = "main", dependencies = {"RRethy/nvim-treesitter-endwise"}, config = _2_, lazy = false}, {"nvim-treesitter/nvim-treesitter-textobjects", enabled = true, branch = "main", event = "VeryLazy", config = _3_}}
