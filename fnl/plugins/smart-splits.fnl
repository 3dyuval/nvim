...
;; ~/.config/kitty/passthrough.conf); at the split edge smart-splits hands off to
;; the neighboring kitty split via its kitty integration. It never touches the WM.
